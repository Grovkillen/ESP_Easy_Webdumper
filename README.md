...
* **Batch mode** is possible using a batch file and call the application with this switch: "ESP.Easy.Webdumper.exe /IP_NUMBER=<ip>". The app will exit once a dump is completed. If you want the small window to not show up during the batch mode you need to add "/SILENT=1" to the command line.
